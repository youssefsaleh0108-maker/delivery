...
plugins {
    ...
    // Reads android/app/google-services.json at build time and generates the Firebase config the
    // SDK initialises from. Without it firebase_core throws at startup and no token is ever issued.
