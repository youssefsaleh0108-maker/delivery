          ...
          children: <Widget>[
            ...
            _card(DeliveryStrings.of(context).deliverTo, <Widget>[
              ListTile(
                ...
                title: Text(
                  widget.addresses.isSet
                      ? widget.addresses.selected!.display
                      : DeliveryStrings.of(context).setDeliveryAddress,
                  style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14.5),
                ),
                subtitle: widget.addresses.selected?.notes == null
                    ? null
                    : Text(widget.addresses.selected!.notes!,
