...
class ButlerRequestDetailsScreen extends StatefulWidget {
  ...
  /// The customer shell's "take me to my basket". Threaded through because the order screen this
  /// page opens for an agreed errand leads to a shop page, and that shop page's View basket has to
  /// land on the shell's one real basket rather than pop back here.
