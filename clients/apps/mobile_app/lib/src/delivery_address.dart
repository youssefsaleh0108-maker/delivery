...
// -------------------------------------------------------------------------------------------
// Wire enums to customer-facing sentences.
//
// The strings themselves live in the shared .arb files; what these functions add is the mapping
// from a server enum to the one sentence that names it, kept beside the store every customer
