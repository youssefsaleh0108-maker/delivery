...
### HyperlocalScreen (Your Neighborhood, Figma 112:1941)  — reachable from Home; driven by test/hyperlocal_screen_test.dart
...
- reached by: Home (StoreHomeScreen) → the "Your Neighborhood" card under the category tiles → pushed over the shell with the shell's cart, address book and onOpenBasket.
