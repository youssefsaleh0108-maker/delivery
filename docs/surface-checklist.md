...
- states: Loading: spinner · Failed first page: t.isrchCouldNotSearch + t.tryAgain · Field under 2 characters: t.isrchTypeMore · Empty: t.isrchEmptyNear / t.isrchEmptyAnywhere, plus t.isrchEmptyTruncated(limit) when the server stopped at its ceiling · No pin: the line t.isrchNotByDistance under the field, no distances.
