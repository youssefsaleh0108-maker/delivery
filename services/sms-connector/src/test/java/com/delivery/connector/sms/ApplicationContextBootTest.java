 ...
 *
 * <p>So this boots the REAL application — {@link SmsConnectorApplication}, its real
 ...
 * port. Nothing is sliced and nothing of sms-connector — the SMS leg of the notification fan-out —
 * is mocked. The test that would catch the bug is the plain fact that the context refreshes at all.
 *
...
@DisplayName("sms-connector's own Spring context")
