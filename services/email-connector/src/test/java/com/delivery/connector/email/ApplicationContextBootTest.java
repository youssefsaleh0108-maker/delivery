 ...
 *
 * <p>So this boots the REAL application — {@link EmailConnectorApplication}, its real
 ...
 * port. Nothing is sliced and nothing of email-connector — the SMTP leg of the notification fan-out
 * — is mocked. The test that would catch the bug is the plain fact that the context refreshes at
 * all.
 *
 ...
 * not.
 *
 * <p><b>What it stubs.</b> The broker, and SMTP by address. {@link StubbedBroker} supplies the one
 ...
 * SMTP, its sibling services and the trace collector — is pointed at a closed port by
...
@DisplayName("email-connector's own Spring context")
